...
public class Stock {
    ...
    public void setMin(double min) {
     ...
     void updatePrice(double currentValue){
        ...
        if (currentValue < min){min = currentValue; this.currentValue = currentValue;}
        else if ((currentValue > min) && (currentValue > max)) {max = currentValue; this.currentValue = currentValue;}
        else if ((currentValue > min) && (currentValue < max)) {this.currentValue = currentValue;}
