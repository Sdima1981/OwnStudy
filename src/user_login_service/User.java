...
boolean blocked = false;
    ...
    public void setBlocked(boolean blocked) {
     ...
     void reset(){loginAttemptsLeft = this.loginAttemptsLeft + 3;
     }
     void block() {while (loginAttemptsLeft == 0) {
     ...
     void login() {
        ...
        if ((loginIn == loginIn) && (this.passwordIn == password) && (loginAttemptsLeft > 0)) {
            System.out.println("Good, we`re in"); int loginAttemptsLeft  = this.loginAttemptsLeft - 1;
        }
